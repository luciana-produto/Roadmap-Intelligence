...
const classificationConfig: Record<DemandClassification, { color: string, label: string }> = {
  ...
  Customizacao: { color: 'bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800', label: 'Customização' }
}
